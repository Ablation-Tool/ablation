...
| vtl | 2.1MB C++ | PARTIAL | system() ×3 all PLAUSIBLE LOW (SafeNet Luna HSM library, admin-only — ChrystokiConfiguration rm+cluster_name + ParentChildProcess::run fork+dup+system(this+8)); sprintf×85 + strcpy×19 pending |
