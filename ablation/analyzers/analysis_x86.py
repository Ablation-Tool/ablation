"""Path-insensitive, flow-sensitive dataflow analysis over an x86-64 CFG.

Usage:
    from ablation.analyzers.analysis_x86 import analyze_cfg
    ...
    init = TaintState(Mode.X64)
    init.taint_reg("rdi", "user")
    result = analyze_cfg(list(from_listing(text)), Mode.X64, initial=init)
...
from .cfg_x86 import CFG, build_cfg
from .insn_x86 import Insn
from .isa_x86 import Mode
from .taint_tracker_x86_labeled import Finding, Policy, TaintState, TaintTracker
