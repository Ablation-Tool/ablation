"""Path-insensitive, flow-sensitive dataflow analysis over a MIPS32/64 CFG.

Usage:
    from ablation.analyzers.analysis_mips import analyze_cfg
    ...
    init = TaintState(Mode.MIPS32)
    init.taint_reg("$a0", "user")
    result = analyze_cfg(list(from_listing(text)), Mode.MIPS32, initial=init)
...
from .cfg_mips import CFG, build_cfg
from .insn_mips import Insn
from .isa_mips import Mode
from .taint_tracker_mips_labeled import Finding, Policy, TaintState, TaintTracker
