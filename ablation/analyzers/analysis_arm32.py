"""Path-insensitive, flow-sensitive dataflow analysis over an ARM32/Thumb CFG.

Usage:
    from ablation.analyzers.analysis_arm32 import analyze_cfg
    ...
    init = TaintState(Mode.ARM)
    init.taint_reg("r0", "user")
    result = analyze_cfg(list(from_listing(text)), Mode.ARM, initial=init)
...
from .cfg_arm32 import CFG, build_cfg
from .insn_arm32 import Insn
from .isa_arm32 import Mode
from .taint_tracker_arm32_labeled import Finding, Policy, TaintState, TaintTracker
